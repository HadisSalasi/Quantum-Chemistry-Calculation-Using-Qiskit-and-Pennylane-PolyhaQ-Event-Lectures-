# PolyhaQ-2026-Quantum-Chemistry-Tutorial-Qiskit-PennyLane
...
In the file "Quantum_Chemistry_(QFT and QPE)_PolyhaQ.ipynb", there are two hands-on exercises on the Quantum Fourier Transform and Quantum Phase Estimation algorithms from Thomas G. Wong's book: Introduction to classical and quantum computing (Wong, Thomas G. Introduction to classical and quantum computing. Omaha, Nebraska: Rooted Grove, 2022).


The notebook "Quantum_Chemistry_(PES)_PolyhaQ.ipynb" provides a step-by-step guide on integrating quantum mechanics with classical chemistry to run quantum algorithms for molecular calculations. For example, you can see all the processes for the hydrogen molecule.
